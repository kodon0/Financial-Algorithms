...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 22 14:55:03 2020
...
def brStk(symbol,sec_type="STK",currency="BRL",exchange="BOVESPA"):
    contract = Contract()
...
'''long_ticks = ["ABEV3.SA","BTOW3.SA","B3SA3.SA","BBAS3.SA","BBDC3.SA","BBDC4.SA","BRAP4.SA","BRKM5.SA", "BRFS3.SA",
           "CCRO3.SA","CMIG4.SA","CIEL3.SA","CPLE6.SA","CPFE3.SA","CSNA3.SA","CYRE3.SA","ECOR3.SA","ENBR3.SA",
           "ELET3.SA","EMBR3.SA","EGIE3.SA","YDUQ3.SA","GGBR4.SA","GOLL4.SA","PCAR4.SA","HYPE3.SA","IGTA3.SA",
           ...
           "VIVT4.SA", "TIMP3.SA", "UGPA3.SA", "USIM5.SA","VALE3.SA","VVAR3.SA"]'''
    
long_ticks = ["ABEV3.SA","BTOW3.SA","B3SA3.SA","BBAS3.SA","BBDC3.SA","PETR3.SA","ITUB4.SA"
              "VALE3.SA","EMBR3.SA","SANB11.SA","ITSA4.SA","VIVT4.SA","JBSS3.SA","ELET3.SA"]
   
tickers = [i.split(".")[0] for i in long_ticks] 

for ticker in tickers:
    try:
        histData(tickers.index(ticker),brStk(ticker),'1 Y', '15 mins')
        time.sleep(60)
...
####################### Technical Indicators for strategy - Intraday #######################
