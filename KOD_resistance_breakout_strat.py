...
# -*- coding: utf-8 -*-
"""
Created on Mon May 25 16:44:51 2020
...
#Note the below indicators may not reflect true intra-day behaviour
...
def CAGR(DF):
    ...
    n = len(df)/(252*78)#Tweaked ->78 5mins periods!
...
tickers_signal = {} #Key is stock, value is volume traded
tickers_ret = {} #Key is stock, value is period returned
