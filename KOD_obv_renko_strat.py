...
# -*- coding: utf-8 -*-
"""
Created on Wed May 27 16:35:12 2020
...
#Strategy: buy/long iff renko bar >= 2 (two or more bars) and 5 day obv => 30deg
#Reverse is true: sell/short if renko bar <= -2, 5day obv <= 30deg
#Exit if -2 <= renko < 2
    ...
    for i in range(len(ohlc_intraday[ticker])):
        if tickers_signal[ticker] == "":
            ...
            if ohlc_renko[ticker]["bar_num"][i]>=2 and ohlc_renko[ticker]["obv_slope"][i]>30:
                #Buy/Long -> Renko bar >= 2 and slope >= +30dg
            ...
            if ohlc_renko[ticker]["bar_num"][i]<=-2 and ohlc_renko[ticker]["obv_slope"][i]<-30:
                #Sell/Short -> Renko bar <= -2 and slope <= -30dg
                tickers_signal[ticker] = "Sell"
